...
I learned how to write a shell script and execute it.
...
This challenge requires us to not use the bash command to write scripts.
...
This challenge requires us to use the shebang line.
...
Testing your script...
Perfect! Your flag:
pwn.college{Mk3H0ss_nr_-7EAbmhgdMewtou3.0VOzMDOxwSNxEzNzEzW}
```

### What i learned

1. The shebang starts with `#!`.
2. Linux treats the file as an interpreted program and invokes the interpreter specified.
...
**Flag** `pwn.college{QyV_rFZlXnSHvMLMfb6tInSoQfY.0VNzMDOxwSNxEzNzEzW}`
...
I learned how to use positional parameters to accept script arguments.
...
**Flag** `pwn.college{U4ogIOuHvHpdQs0j7NHi8WZvJLV.0lNzMDOxwSNxEzNzEzW}`
...
1. Spacing around `[` and `]` is required.
2. `if`, `then`, and `fi` define the conditional block.

## Scripting with default case

This challenge uses the `if-elif-else` structure.
...
1. `else` catches all unmatched cases.
2. `fi` terminates the conditional block.

## Scripting with multiple conditions

This challenge uses the `elif` keyword.

### My solve

**Flag** `pwn.college{8885FWJGnSzIGn9LWTNZUzo6Oo5.0FOzMDOxwSNxEzNzEzW}`
...
I practiced using `elif` for multiple conditions.

## Reading shell scripts

This challenge requires us to read a script file.

### My solve

**Flag** `pwn.college{kCuidU1bIEnp2yCZN4vDuRg1816.0lMwgDOxwSNxEzNzEzW}`
...
I learned how to read and understand a shell script to extract required input.
# 12. Chaining Commands
